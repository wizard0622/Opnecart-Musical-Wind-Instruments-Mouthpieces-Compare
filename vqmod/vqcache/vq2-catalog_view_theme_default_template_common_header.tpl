...
<?php if($sitelinks_search_box) echo $sitelinks_search_box; ?>
...
<link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/product_compare.css" />
      <link rel="stylesheet" type="text/css" href="catalog/view/javascript/slick/slick.css" />
<script type="text/javascript" src="catalog/view/javascript/product_compare.js"></script>
...
<?php if(!isset($this->request->get['route']) || $this->request->get['route'] != "product/compare") { ?> <div id="product_compare_wrapper"></div> <?php } ?>
            <?php if ($error) { ?>
