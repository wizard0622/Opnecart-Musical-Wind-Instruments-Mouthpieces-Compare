...
'height'       => $result['height'],
			...
			// $this->data['sorts'][] = array(
				...
				// 'href'  => $this->url->link($route, $path . '&sort=p.sort_orderASC' . $url)
			// );
			
			// $this->data['sorts'][] = array(
				// 'text'  => 'ISBN ASC',
				// 'value' => 'p.isbn-ASC',
				// 'href'  => $this->url->link($route, $path . '&sort=p.isbnASC' . $url)
			// );
			// $this->data['sorts'][] = array(
				// 'text'  => 'ISBN DESC',
				// 'value' => 'p.isbn-DESC',
				// 'href'  => $this->url->link($route, $path . '&sort=p.isbnDESC' . $url)
			// );
			...
			$this->data['sorts'][] = array(
				'text'  => 'Brand',
				'value' => 'pd.name-ASC',
				'href'  => $this->url->link($route, $path . '&sort=pd.name' . $url)
			);

			$this->data['sorts'][] = array(
				'text'  => 'Series',
				'value' => 'p.sku-ASC',
				'href'  => $this->url->link($route, $path . '&sort=p.sku' . $url)
			);
			
			// $this->data['sorts'][] = array(
				// 'text'  => $this->language->get('text_name_desc'),
				// 'value' => 'pd.name-DESC',
				// 'href'  => $this->url->link($route, $path . '&sort=pd.nameDESC' . $url)
			// );

			// $this->data['sorts'][] = array(
				// 'text'  => $this->language->get('text_price_asc'),
				// 'value' => 'p.price-ASC',
				// 'href'  => $this->url->link($route, $path . '&sort=p.priceASC' . $url)
			// ); 

			// $this->data['sorts'][] = array(
				// 'text'  => $this->language->get('text_price_desc'),
				// 'value' => 'p.price-DESC',
				// 'href'  => $this->url->link($route, $path . '&sort=p.priceDESC' . $url)
			// ); 
			...
			// if ($this->config->get('config_review_status')) {
				// $this->data['sorts'][] = array(
					...
					// 'value' => 'rating-DESC',
					// 'href'  => $this->url->link($route, $path . '&sort=ratingDESC' . $url)
				// ); 

				// $this->data['sorts'][] = array(
					// 'text'  => $this->language->get('text_rating_asc'),
					// 'value' => 'rating-ASC',
					// 'href'  => $this->url->link($route, $path . '&sort=ratingASC' . $url)
				// );
			// }
			...
			$this->data['sorts'][] = array(
				'text'  => 'Model',
				'value' => 'p.model-ASC',
				'href'  => $this->url->link($route, $path . '&sort=p.model' . $url)
			);

			// $this->data['sorts'][] = array(
				// 'text'  => $this->language->get('text_model_desc'),
				// 'value' => 'p.model-DESC',
				// 'href'  => $this->url->link($route, $path . '&sort=p.modelDESC' . $url)
			// );
		
			$this->data['sorts'][] = array(
				'text'  => 'Bore',
				'value' => 'p.isbn-ASC',
				'href'  => $this->url->link($route, $path . '&sort=p.isbn' . $url)
			);
			
			$this->data['sorts'][] = array(
				'text'  => 'Diameter',
				'value' => 'p.ean-ASC',
				'href'  => $this->url->link($route, $path . '&sort=p.ean' . $url)
			);
			
			$this->data['sorts'][] = array(
				'text'  => 'Cup depth',
				'value' => 'p.jan-ASC',
				'href'  => $this->url->link($route, $path . '&sort=p.jan' . $url)
			);
