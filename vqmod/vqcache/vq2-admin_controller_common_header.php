...
$this->data['text_cacheremove'] = $this->language->get('text_cacheremove');
...
$this->data['cacheremove'] = $this->url->link('cacheremove/cacheremove', 'token=' . $this->session->data['token'], 'SSL');
