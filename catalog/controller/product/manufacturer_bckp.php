...
class ControllerProductManufacturer extends Controller {  
	...
	public function product() {
		...
		if (isset($this->request->get['path'])) {
			...
			if(!$category_info) unset($category_info);
		}
		...
		if ($manufacturer_info) {
			...
			$this->data['heading_title'] = $manufacturer_info['name'] . " Mouthpieces comparison chart";
		...
		//	); 
				...
				'text'  => 'Series',
				'value' => 'p.sku-ASC',
				'href'  => $this->url->link('product/manufacturer/product', 'manufacturer_id=' . $this->request->get['manufacturer_id'] . '&sort=p.sku&order=ASC' . $url)
			);
		...
		//	);
			...
			$this->data['sorts'][] = array(
				...
				'text'  => 'Bore',
				'value' => 'p.isbn-ASC',
				'href'  => $this->url->link('product/manufacturer/product', 'manufacturer_id=' . $this->request->get['manufacturer_id'] . '&sort=p.isbn&order=ASC' . $url)
			);
			
			$this->data['sorts'][] = array(
				'text'  => 'Diameter',
				'value' => 'p.ean-ASC',
				'href'  => $this->url->link('product/manufacturer/product', 'manufacturer_id=' . $this->request->get['manufacturer_id'] . '&sort=p.ean&order=ASC' . $url)
			);
			
			$this->data['sorts'][] = array(
				'text'  => 'Cup depth',
				'value' => 'p.jan-ASC',
				'href'  => $this->url->link('product/manufacturer/product', 'manufacturer_id=' . $this->request->get['manufacturer_id'] . '&sort=p.jan&order=ASC' . $url)
			);
