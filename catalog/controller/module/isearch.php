...
class ControllerModuleIsearch extends Controller {
	...
	public function ajaxget() {
		...
		$resultsByNameAndModel = $this->model_catalog_isearch->iSearch($keywords,$searchIn,$useImages,$strictSearch,$singularize,$checkRules,'','ASC',$cat_id,false,$excludeTerms,$excludeRules/*{HOOK_SEARCH_IN_CACHE_ATTRIBUTE}*/);
