...
.iSearchBoxWrapper .iSearchBox {
	width: <?php echo (empty($data['iSearch']['ResultsBoxWidth'])) ? '278px' : $data['iSearch']['ResultsBoxWidth'] . (is_numeric($data['iSearch']['ResultsBoxWidth']) ? 'px' : ''); ?> !important;	
}
...
<script type="text/javascript">
	...
	var moreResultsText = '<?php echo !empty($data['iSearch'][$this->config->get('config_language_id')]['ResultsMoreResultsLabel']) ? $data['iSearch'][$this->config->get('config_language_id')]['ResultsMoreResultsLabel'] : 'View All Results';?>';
