<?php echo $header; ?><?php echo $column_left; ?><?php echo $column_right; ?>
    ...
    <h1><?php echo $heading_title; ?> Mouthpiece Comparator</h1>
    ...
    <?php if ($products) { ?>
        ...
        <div class="product-compare"><a href="<?php echo $compare; ?>"
                                        id="compare-total"><?php echo $text_compare; ?></a>
        </div>
        ...
        <table class="" style="width:99%;">
                                            <tr class="theader">
<td class="theader"> 
<img src="../image/m16.png" style="margin-left:5px;" ></img>
...
<?php } ?>
            <td class="Cell" id="Cell-<?php echo $product['product_id']; ?>" onclick="CompareAction(this,<?php echo $product['product_id']; ?>)"><div class="compare-icon<?php if(isset($this->session->data['compare']) && in_array($product['product_id'],$this->session->data['compare'])) {?> minus<?php } ?>" style="width:auto;"> </div>
                    <td class="Cell" style="width:auto;">
