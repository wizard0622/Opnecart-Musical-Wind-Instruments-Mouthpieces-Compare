...
<script type="text/javascript">
    ...
    <div class="limit"><?php echo $text_limit; ?>
      <select onchange="location = this.value;">
        ...
        <table class="" style="width:99%;">
                                            ...
                                            <img src="http://www.mouthpiececomparator.com/image/m16.png" style="margin-left:5px;"></img>
 ...
 ?>
    ...
    <?php if(isset($this->session->data['compare']) && in_array($product['product_id'],$this->session->data['compare'])) {?> 
           ...
           <input type="image" value="Send to comparator" style="padding: 5px;" src="catalog/view/theme/default/image/success.png" id="icon-<?php echo $product['product_id']; ?>" onclick="location='http://www.mouthpiececomparator.com/index.php?route=product/compare&remove=<?php echo $product['product_id']; ?>'" />
     <?php } else {?>                
            <tr>
                      <td class="Cell" style="width:5px;">

                   
         <input type="image" value="Send to comparator" style="padding: 5px;" src="../image/minus.png"  id="icon-<?php echo $product['product_id']; ?>"
                               onclick="SetComparedIcon(<?php echo $product['product_id']; ?>); addToCompareAjax('<?php echo $product['product_id']; ?>');" />
     <?php } ?>
                    </td>
...
<input type="submit" value="Compare now!" onclick="window.location='/index.php?route=product/compare';"> <?php echo $text_comparet; ?>:<a href="<?php echo $compare; ?>" id="compare-total"><?php echo $text_compare; ?></a></div>
