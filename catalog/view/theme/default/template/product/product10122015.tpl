...
<div class="product-info">
        <div class="right">
                ...
                <div><img src="catalog/view/theme/default/image/stars-<?php echo $rating; ?>.png" href="#rateit" alt="<?php echo $reviews; ?>"/>&nbsp;&nbsp;<a style="font-size:1.2em;" 
                
                          onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a></div>
              <div ></div>
...
<div id="tabs-container">
    <ul class="tabs-menu">
        ...
        <li><?php if(empty($this->session->data['compare']) || array_search($product_id, $this->session->data['compare']) === false) { ?>   
               <a class="" id="addp2c" href="#" onclick="CompareAction(this, '<?php echo $product_id; ?>');">Add to comparator</a>
             <?php } else { ?>
               <a class="minus" href="#" id="addp2c" onclick="CompareAction(this, '<?php echo $product_id; ?>');">Remove from comparator</a>
            <?php } ?>                              
        </li>          
        <li><a href="#">I play it</a></li>
        <li><a href="#rateit">Rate it</a></li>
    ...
    <div class="tab">
        <div id="tab-1" class="tab-content">
                ...
                <div style="display:table; padding-bottom: 10px;width: 100%;">
                    ...
                    <div style="display: table-cell; width: 45%; border-right: 1px solid #E7E7E7;">
                    ...
                    <!-- SPECIFICATIONS END -->
                        ...
                        <div">
                                            ...
                                            <div style="width:520px; display:table-cell; padding-left:20px;">

                                                    <!-- May we recommend-->
                                                   
                                                    <h3>May we recommend</h3> 
<i class="icon-beer">&nbsp;</i>font awesome   
...
This table shows the most similar mouthpieces by other manufacturers based on different parameters. Change those parameters to expand or narrow the result.
                                                    </br>
...
<div style="clear:both;"></div>
   ...
   <!-- BOTTOM-->
    ...
    <div id="tab-review" class="tab-content">
        ...
        <br/><span style="font-size: 11px;"><?php echo $text_note; ?></span> 
        <br/>
