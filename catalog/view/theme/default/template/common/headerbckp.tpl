...
<style media="screen" type="text/css">  
   ...
   overflow: hidden;
   background: url(image/down.png) no-repeat right #ebebeb;
        ...
        <div id="container">
            <div id="header">
                ...
                <div style="float: left; margin-right: 20px;">
                         ...
                         <?php if ($logo) { ?>
                                <div><a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="Mouthpiece Comparator" alt="<?php echo $name; ?>" /></a></div>
                                <?php } ?>
                         </div>
...
<?php if($category['id']>0){?>
                                  <option value="<?php echo $category['id'];?>" <?php if($category['id']==$cat_id) {echo 'selected';  $tcat=$category['id'];} ?>  ><?php echo $category['name']; ?></option>
								  <?php } } $a=$a+1;  } ?>
                       </select>
...
<?php } ?>
            ...
            <div id="menu" style="">
                ...
                <ul>
                    ...
                    <li><a href="<? foreach ($categories as $category) { if($category['id']==$cat_id) echo $category['href']; }?>"><?php echo 'Database'; ?></a>
                            <?php
